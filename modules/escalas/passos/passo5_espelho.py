...
# Configuração da página em tela cheia (Sem Sidebar e Sem Menus de Login)
st.set_page_config(page_title="SIOP - Espelho do Passo 5", layout="wide")
...
# Captura Mês e Ano diretamente da URL
...
if not df_escala.empty:
    ...
    st.info("💡 Nenhuma escala salva localizada no Supabase para este período.")

# Atualização em tempo real do espelho sem pedir intervenção do utilizador
time.sleep(3)
st.rerun()